...
namespace Michsky.UI.Dark
{
    public class PanelTabManager : MonoBehaviour
    {
        ...
        {
            if (panelIndex != currentPanelIndex && panelIndex >= 0 && panelIndex < panels.Count)
            {
                currentPanel = panels[currentPanelIndex];
                ...
                currentButtonlIndex = currentPanelIndex;
        ...
        {
            if (newPanel != currentPanelIndex && newPanel >= 0 && newPanel < panels.Count)
            {
                currentPanel = panels[currentPanelIndex];
